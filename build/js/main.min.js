...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_4__["initBurgerMenu"])(); // Modules
  // ---------------------------------
...
var initBurgerMenu = function initBurgerMenu() {
  var burgerBtns = document.querySelectorAll('[data-burger-btn]');

  if (burgerBtns.length) {
    var menuBody = document.querySelector('[data-burger-body]');
    burgerBtns.forEach(function (burgerBtn) {
      ...
      menuBody.addEventListener('click', function (e) {
        var burgerLinks = menuBody.querySelectorAll('.burger__link');
